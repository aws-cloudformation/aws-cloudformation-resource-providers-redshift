...
public class Translator {
   ...
   */
  static AuthorizeClusterSecurityGroupIngressRequest translateToCreateRequest(final ResourceModel model) {
    return AuthorizeClusterSecurityGroupIngressRequest.builder()
            .clusterSecurityGroupName(model.getClusterSecurityGroupName())
            .cidrip(model.getCIDRIP())
            .ec2SecurityGroupName(model.getEC2SecurityGroupName())
            .ec2SecurityGroupOwnerId(model.getEC2SecurityGroupOwnerId())
            .build();
  }
   ...
   */
  static RevokeClusterSecurityGroupIngressRequest translateToDeleteRequest(final ResourceModel model) {
    return RevokeClusterSecurityGroupIngressRequest.builder()
            .clusterSecurityGroupName(model.getClusterSecurityGroupName())
            .cidrip(model.getCIDRIP())
            .ec2SecurityGroupName(model.getEC2SecurityGroupName())
            .ec2SecurityGroupOwnerId(model.getEC2SecurityGroupOwnerId())
