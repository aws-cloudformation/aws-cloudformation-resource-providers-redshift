...
public class ReadHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final ResourceModel requestResourceModel = getResourcePolicyRequestResourceModel();
        final ResourceModel responseResourceModel = getResourcePolicyResponseResourceModel();
