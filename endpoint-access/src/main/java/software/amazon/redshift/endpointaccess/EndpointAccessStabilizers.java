...
public class EndpointAccessStabilizers {
    public static boolean isEndpointActive(final ProxyClient<RedshiftClient> proxyClient, ResourceModel model, CallbackContext cxt) {
        // TODO what else uniquely describes the endpoint?
        ...
        DescribeEndpointAccessResponse response = proxyClient.injectCredentialsAndInvokeV2(
                request, proxyClient.client()::describeEndpointAccess
        );
    ...
    public static boolean isEndpointDeleted(final ProxyClient<RedshiftClient> proxyClient, ResourceModel model, CallbackContext cxt) {
        // TODO what else uniquely describes the endpoint?
